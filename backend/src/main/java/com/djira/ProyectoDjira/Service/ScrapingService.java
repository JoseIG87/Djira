...
public interface ScrapingService {
	...
	List<Ropa> obtenerProductosDorian(String path1, String path2) throws ServiceException;
	
	List<Ropa> obtenerProductosColantuono(String path) throws ServiceException;
